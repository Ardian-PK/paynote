...
INSERT INTO `cicilan` (`id_category`, `name_category`, `created_at`, `updated_at`) VALUES
(1, 'Food', NULL, NULL),
...
(6, '2023_11_22_025850_create_cicilan_table', 1),
...
--
ALTER TABLE `expenses`
  ADD CONSTRAINT `expenses_id_category_foreign` FOREIGN KEY (`id_category`) REFERENCES `cicilan` (`id_category`);

--
-- Constraints for table `incomes`
--
ALTER TABLE `incomes`
  ADD CONSTRAINT `incomes_id_category_foreign` FOREIGN KEY (`id_category`) REFERENCES `cicilan` (`id_category`);
COMMIT;
